#ifndef _SKINSEG_BOX_INTERACTIVE_MARKER_H_
#define _SKINSEG_BOX_INTERACTIVE_MARKER_H_
...
//
// Usage:
//   BoxInteractiveMarker box("left_hand", &im_server);
//   box.set_pose_stamped(ps);
//   box.Show();
//
//   // Wait for user input, e.g., std::cin or waitKey
//   double min_x = box.min_x();
class BoxInteractiveMarker {
 public:
  BoxInteractiveMarker(const std::string& name,
...
#endif  // _SKINSEG_BOX_INTERACTIVE_MARKER_H_
