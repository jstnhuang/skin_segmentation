...
namespace skinseg {
BoxInteractiveMarker::BoxInteractiveMarker(
...
void BoxInteractiveMarker::Show() {
  Update();
  im_server_->setCallback(
      name_ + "-pos_x", boost::bind(&BoxInteractiveMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-neg_x", boost::bind(&BoxInteractiveMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-pos_y", boost::bind(&BoxInteractiveMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-neg_y", boost::bind(&BoxInteractiveMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-pos_z", boost::bind(&BoxInteractiveMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-neg_z", boost::bind(&BoxInteractiveMarker::Feedback, this, _1));
  im_server_->applyChanges();
}

void BoxInteractiveMarker::set_pose_stamped(const PoseStamped& pose_stamped) {
...
void BoxInteractiveMarker::set_min_x(double min_x) {
  min_x_ = min_x;
  Update();
}
void BoxInteractiveMarker::set_max_x(double max_x) {
  max_x_ = max_x;
  Update();
}
void BoxInteractiveMarker::set_min_y(double min_y) {
  min_y_ = min_y;
  Update();
}
void BoxInteractiveMarker::set_max_y(double max_y) {
  max_y_ = max_y;
  Update();
}
void BoxInteractiveMarker::set_min_z(double min_z) {
  min_z_ = min_z;
  Update();
}
void BoxInteractiveMarker::set_max_z(double max_z) {
  max_z_ = max_z;
  Update();
}

double BoxInteractiveMarker::min_x() { return min_x_; }
double BoxInteractiveMarker::min_y() { return min_y_; }
double BoxInteractiveMarker::min_z() { return min_z_; }
double BoxInteractiveMarker::max_x() { return max_x_; }
double BoxInteractiveMarker::max_y() { return max_y_; }
double BoxInteractiveMarker::max_z() { return max_z_; }

void BoxInteractiveMarker::Update() {
...
void BoxInteractiveMarker::UpdateArrow(const std::string& axis,
...
void BoxInteractiveMarker::Feedback(
...
void BoxInteractiveMarker::MakeBox(InteractiveMarker* box) {
...
void BoxInteractiveMarker::MakeArrow(
    const std::string& axis, const std::string& polarity,
